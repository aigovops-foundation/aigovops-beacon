  ...
  function init() {
    ...
    function renderDiploma(r) {
      return ''
        ...
        +       '<circle cx="32" cy="32" r="30" fill="#1F5E3A"/>'
        +       '<circle cx="32" cy="32" r="22" fill="none" stroke="#2E7D4F" stroke-width="1.5" opacity="0.7"/>'
        +       '<text x="32" y="40" font-family="system-ui,sans-serif" font-size="20" font-weight="700" fill="#2E7D4F" text-anchor="middle">Y</text>'
        +     '</svg>'
        +   '</div>'
    ...
    function standaloneDiploma(innerHtml) {
      return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>AiGovOps Beacon — Framework Lab Diploma</title>'
        ...
        + '.diploma-inner{background:#fff;border:3px solid #1F5E3A;border-radius:14px;padding:3rem 4rem;max-width:780px;box-shadow:0 14px 40px -20px rgba(14,27,28,0.18);}'
        + '.diploma-medallion{display:flex;justify-content:center;margin-bottom:1rem;}'
        + '.diploma-kicker{font-family:"DM Mono",monospace;font-size:0.8rem;text-transform:uppercase;letter-spacing:0.18em;color:#1F5E3A;text-align:center;margin:0 0 0.5rem;}'
        ...
        + '.diploma-level{text-align:center;font-size:1.4rem;font-weight:600;color:#1F5E3A;margin:0 0 1.5rem;}'
        ...
        + '@media print{body{padding:0;}.diploma-inner{border:2px solid #1F5E3A;box-shadow:none;page-break-inside:avoid;}}'
